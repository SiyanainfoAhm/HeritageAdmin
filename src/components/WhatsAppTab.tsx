        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Join us for the Heritage Walk this weekend! 🏛️ Experience the rich history of our city...
                </div>
              </td>
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button
                  className="view-whatsapp-btn p-2 text-secondary hover:text-primary hover:bg-gray-100 rounded-lg transition-colors"
            ...
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Special monsoon festival discount! 🌧️ Get 20% off on all heritage tour packages...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
            ...
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Artisan Spotlight registration is now open! 🎨 Showcase your traditional crafts...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
