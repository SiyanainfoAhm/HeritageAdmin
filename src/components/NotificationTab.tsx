...
const NotificationTab: React.FC<NotificationTabProps> = ({ onAddNotification, onViewDetails }) => {
  const [searchTerm, setSearchTerm] = useState('');

  return (
    <div id="notification-tab" className="tab-content">
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-3 mt-4">
          <div className="relative">
            <button
              id="filter-notification-audience-btn"
              className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 flex items-center !rounded-button whitespace-nowrap"
            >
              <span>Audience</span>
            ...
            <div
              id="filter-notification-audience-dropdown"
          ...
          <div className="relative">
            <button
              id="filter-notification-date-btn"
              className="bg-white border border-gray-200 rounded-lg px-3 py-2 text-sm text-gray-600 flex items-center !rounded-button whitespace-nowrap"
            >
              <span>Date</span>
              <i className="ri-arrow-down-s-line ml-2"></i>
            ...
            <div
              id="filter-notification-date-dropdown"
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm font-medium text-gray-900">
                  Summer Heritage Walk Launch
                </div>
              </td>
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Join us for special guided tours of Ahmedab...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                <button
                  className="view-notification-btn p-2 text-secondary hover:text-primary hover:bg-gray-100 rounded-lg transition-colors"
            ...
            <tr className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Enjoy 20% off on all heritage tour packages ...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
            ...
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm font-medium text-gray-900">
                  Artisan Spotlight Registration
                </div>
              </td>
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Register now to be featured in our Artisan Sp....
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
            ...
            <tr className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Enhance your skills with our professional cert...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
            ...
            <tr className="hover:bg-gray-50">
              <td className="px-6 py-4 whitespace-nowrap">
                <div className="text-sm font-medium text-gray-900">
                  Weekend Heritage Events
                </div>
              </td>
              <td className="px-6 py-4">
                <div className="text-sm text-gray-900">
                  Check out these special heritage events ha...
                </div>
              </td>
              <td className="px-6 py-4 whitespace-nowrap">
                <span className="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-blue-100 text-blue-800">
